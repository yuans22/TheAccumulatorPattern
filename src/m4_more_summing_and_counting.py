...
#     -- what an ORACLE answer is 30 , 500000050
#     -- what a KNOWN (typically, BY-HAND) answer is 6
#     -- what a FORMULA answer is 12496122
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 3
    answer = count_cosines_from(4, 9, 0.21)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(9, 11, 0.10)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 12
    answer = count_cosines_from(3, 21, -0.3)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 5.36886  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 120)
